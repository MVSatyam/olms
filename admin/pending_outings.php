...
if ($_SESSION['admin'] != NULL) {
    ...
    $sql = "SELECT * FROM outings WHERE permission='wait...' ORDER BY id ASC";
    ...
    if ($count == 0) {
        ...
        $all_pending_outings = $all_pending_outings . '</tbody></table></div>';
    }
    ...
    <body class="skin-light">
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top scrolling-navbar">
                <!-- Navbar brand -->
                <a class="navbar-brand" href="#"><b>RGUKT OLMS | Pending-Outings</b></a>
                <!-- Collapse button -->
        ...
        <main>
            <div class="container" style="margin-top: 100px;">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center"><a>All Pending Outings</a></h4>
                        <div id="all_pending_outings">
                            <?php echo $all_pending_outings; ?>
                        </div>
                    </div>
                </div>
            ...
            $(document).on('click', '#grantOuting', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        // console.log(result);
                        $('#all_pending_outings').html(result);
                    }
                })
            })
        </script>
