...
if ($_SESSION['admin'] != NULL) {
    ...
    $sql = "SELECT * FROM leaves WHERE permission='granted' ORDER BY id ASC";
    ...
    <body class="skin-light">
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top scrolling-navbar">
                <!-- Navbar brand -->
                <a class="navbar-brand" href="#"><b>RGUKT OLMS | Approved-Leaves</b></a>
                <!-- Collapse button -->
        ...
        <main>
            <div class="container" style="margin-top: 100px;">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center"><a>All Approved Leaves</a></h4>
