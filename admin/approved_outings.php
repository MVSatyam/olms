...
if ($_SESSION['admin'] != NULL) {
    ...
    $sql = "SELECT * FROM outings WHERE permission='granted' ORDER BY id ASC";
    ...
    <body class="skin-light">
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top scrolling-navbar">
                <!-- Navbar brand -->
                <a class="navbar-brand" href="#"><b>RGUKT OLMS | Approved-Outings</b></a>
                <!-- Collapse button -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="leavesDrop">
                                <a class="dropdown-item" href="pending_leaves.php">Pending Leaves</a>
