    ...
    <body class="skin-light bg-white">
        ...
        <header>
            <nav class="navbar navbar-expand-md navbar-light bg-white fixed-top">
                ...
                <a href="#" class="navbar-brand"><b>RGUKT OLMS | Student SignIn</b></a>
            ...
            <div class="jumbotron color-grey-light mt-70">
                <div class="d-flex align-items-center h-100">
                    <div class="container text-center py-5">
                        <h3 class="mb-0">Student SignIn</h3>
                    </div>
                </div>
            </div>
                        ...
                        <section class="mb-5">
                            <form action="login.php" method="post">
                                ...
                                <div class="text-center pb-2">
                                    <button type="submit" class="btn btn-success mb-4 signIn" name="user_signin">Sign In</button>
                                </div>

                                <div class="d-flex justify-content-center">
                                    <p>Don't have account? Please Click <a href="register.php">Sign Up</a></p>
                                </div>
                            </form>
                        </section>
                    </div>
...
if (isset($_POST['user_signin'])) {
    ...
    $sql = "SELECT * FROM users WHERE user_id='$user_id' and user_passwd='$user_passwd'";
    $query = mysqli_query($conn, $sql);

    $count = mysqli_num_rows($query);

    if ($count == 1) {
        $_SESSION['student'] = $user_id;
        header('location: ./');
    }
    else{
