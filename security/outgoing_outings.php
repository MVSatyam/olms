...
if ($_SESSION['security'] != NULL) {
    ...
    $sql = "SELECT * FROM outings WHERE permission='granted' and outgoing='no' ORDER BY id ASC";
    ...
    <body class="skin-light">
        ...
        <main>
            <div class="container" style="margin-top: 100px;">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center"><a>All Outgoing Outings</a></h4>
                        <div id="all_outgoing_outings">
                            <?php echo $all_outgoing_outings; ?>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).on('click', '#markAsGone', function() {
                var user_id = $(this).data('userid');
                var outing_id = $(this).data('outingid');

                $.ajax({
                    url: 'mark_as_gone.php',
                    type: 'post',
                    data: 'user_id=' + user_id + '&outing_id=' + outing_id,
                    success: function(result) {
                        // console.log(result);
                        $('#all_outgoing_outings').html(result);
                    }
                })
            })
        </script>
