...
if ($_SESSION['security'] != NULL) {
    ...
    $sql = "SELECT * FROM outings WHERE permission='granted' and outgoing='yes' and incoming='no' ORDER BY id ASC";
    ...
    if ($count == 0) {
        ...
        while ($outing_row = mysqli_fetch_assoc($query)) {
            ...
            $all_incoming_outings = $all_incoming_outings . '<tr>
                                            ...
                                            <td><button class="btn btn-outline-danger btn-sm waves-effect p-1" id="markAsDone" style="" data-userid="' . $outing_row['user_id'] . '" data-outingid="' . $outing_row['id'] . '">Mark as Done</button></td>
                                        </tr>';
        }
    ...
    <body class="skin-light">
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top scrolling-navbar">
                <!-- Navbar brand -->
                <a class="navbar-brand" href="#"><b>RGUKT OLMS | Outgoing-Outings</b></a>
                <!-- Collapse button -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="leavesDrop">
                                ...
                                <a class="dropdown-item" href="incoming_leaves.php">Incoming Leaves</a>
                            </div>
                        </li>
        ...
        <main>
            <div class="container" style="margin-top: 100px;">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center"><a>All Incoming Outings</a></h4>
                        <div id="all_incoming_outings">
                            <?php echo $all_incoming_outings; ?>
                        </div>
                    </div>
                </div>
            ...
            $(document).on('click', '#markAsDone', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        // console.log(result);
                        $('#all_incoming_outings').html(result);
                    }
                })
            })
        </script>
